import{n as e}from"./vue-i18n-BnMVFRRW.js";import{$ as t,A as n,B as r,Bn as i,Bt as a,H as o,Hn as s,It as c,J as l,Kt as u,Mt as d,Ot as f,Qn as p,Rt as m,S as h,Tt as g,U as _,Un as v,V as y,W as b,Wt as x,X as S,Z as C,_n as w,fn as T,ir as E,rr as ee,st as te,t as D,tr as O,ut as k,vt as A,w as ne,yn as j}from"./runtime-dom.esm-bundler-CvL4s6M5.js";import{F as re,I as M,c as N,m as P,r as F,t as I}from"./QBtn-DrxD4dLu.js";import{B as ie,V as L,_ as R,g as ae,h as z,m as oe,p as B,q as se,t as ce,v as V,y as H,z as le}from"./index-DHmQslli.js";import{l as U,m as W,n as ue,t as G,u as K}from"./defineProperty-BEyEPNmF.js";import{t as de}from"./QList-DRh2hJKy.js";import{t as fe}from"./QPage-hOvNssGF.js";import{r as pe,s as me}from"./time-BNHSR-sE.js";import{r as he,t as q}from"./airplanesRepository-h4l0p3vZ.js";import{t as ge}from"./_plugin-vue_export-helper-BDNMzG2s.js";var _e=M({name:`QSpace`,setup(){let e=k(`div`,{class:`q-space`});return()=>e}}),ve=M({name:`QSlideTransition`,props:{appear:Boolean,duration:{type:Number,default:300}},emits:[`show`,`hide`],setup(e,{slots:t,emit:n}){let r=!1,i,a,o=null,s=null,c,l;function u(){i?.(),i=null,r=!1,o!==null&&(clearTimeout(o),o=null),s!==null&&(clearTimeout(s),s=null),a?.removeEventListener(`transitionend`,c),c=null}function d(t,n,a){n!==void 0&&(t.style.height=`${n}px`),t.style.transition=`height ${e.duration}ms cubic-bezier(.25, .8, .50, 1)`,r=!0,i=a}function p(e,t){e.style.overflowY=null,e.style.height=null,e.style.transition=null,u(),t!==l&&n(t)}function m(t,n){let i=0;a=t,r?(u(),i=t.offsetHeight===t.scrollHeight?0:void 0):(l=`hide`,t.style.overflowY=`hidden`),d(t,i,n),o=setTimeout(()=>{o=null,t.style.height=`${t.scrollHeight}px`,c=e=>{s=null,(Object(e)!==e||e.target===t)&&p(t,`show`)},t.addEventListener(`transitionend`,c),s=setTimeout(c,e.duration*1.1)},100)}function h(t,n){let i;a=t,r?u():(l=`show`,t.style.overflowY=`hidden`,i=t.scrollHeight),d(t,i,n),o=setTimeout(()=>{o=null,t.style.height=0,c=e=>{s=null,(Object(e)!==e||e.target===t)&&p(t,`hide`)},t.addEventListener(`transitionend`,c),s=setTimeout(c,e.duration*1.1)},100)}return f(()=>{r&&u()}),()=>k(D,{css:!1,appear:e.appear,onEnter:m,onLeave:h},t.default)}}),J=v({}),ye=Object.keys(F),be=M({name:`QExpansionItem`,props:{...F,...L,...H,icon:String,label:String,labelLines:[Number,String],caption:String,captionLines:[Number,String],dense:Boolean,toggleAriaLabel:String,expandIcon:String,expandedIcon:String,expandIconClass:[Array,String,Object],duration:{},headerInsetLevel:Number,contentInsetLevel:Number,expandSeparator:Boolean,defaultOpened:Boolean,hideExpandIcon:Boolean,expandIconToggle:Boolean,switchToggleSide:Boolean,denseToggle:Boolean,group:String,popup:Boolean,headerStyle:[Array,String,Object],headerClass:[Array,String,Object]},emits:[...ie,`click`,`afterShow`,`afterHide`],setup(e,{slots:t,emit:n}){let{proxy:{$q:i}}=te(),a=V(e,i),o=s(e.modelValue===null?e.defaultOpened:e.modelValue),c=s(null),l=B(),{show:u,hide:d,toggle:p}=le({showing:o}),m,g,_=r(()=>`q-expansion-item q-item-type q-expansion-item--${o.value?`expanded`:`collapsed`} q-expansion-item--${e.popup?`popup`:`standard`}`),v=r(()=>e.contentInsetLevel===void 0?null:{[`padding`+(i.lang.rtl?`Right`:`Left`)]:e.contentInsetLevel*56+`px`}),y=r(()=>!e.disable&&(e.href!==void 0||e.to!==void 0&&e.to!==null&&e.to!==``)),b=r(()=>{let t={};return ye.forEach(n=>{t[n]=e[n]}),t}),x=r(()=>y.value||!e.expandIconToggle),S=r(()=>e.expandedIcon!==void 0&&o.value?e.expandedIcon:e.expandIcon||i.iconSet.expansionItem[e.denseToggle?`denseIcon`:`icon`]),C=r(()=>!e.disable&&(y.value||e.expandIconToggle)),w=r(()=>({expanded:o.value,detailsId:l.value,toggle:p,show:u,hide:d})),E=r(()=>{let t=e.toggleAriaLabel===void 0?i.lang.label[o.value?`collapse`:`expand`](e.label):e.toggleAriaLabel;return{role:`button`,"aria-expanded":o.value?`true`:`false`,"aria-controls":l.value,"aria-label":t}});T(()=>e.group,e=>{g?.(),e!==void 0&&M()});function ee(e){y.value||p(e),n(`click`,e)}function D(e){e.keyCode===13&&O(e,!0)}function O(e,t){!t&&!e.qAvoidFocus&&c.value?.focus(),p(e),re(e)}function A(){n(`afterShow`)}function ne(){n(`afterHide`)}function M(){m===void 0&&(m=oe()),o.value&&(J[e.group]=m);let t=T(o,t=>{t?J[e.group]=m:J[e.group]===m&&delete J[e.group]}),n=T(()=>J[e.group],(e,t)=>{t===m&&e!==void 0&&e!==m&&d()});g=()=>{t(),n(),J[e.group]===m&&delete J[e.group],g=void 0}}function F(){let t={class:[`q-focusable relative-position cursor-pointer${e.denseToggle&&e.switchToggleSide?` items-end`:``}`,e.expandIconClass],side:!e.switchToggleSide,avatar:e.switchToggleSide},n=[k(N,{class:`q-expansion-item__toggle-icon`+(e.expandedIcon===void 0&&o.value?` q-expansion-item__toggle-icon--rotated`:``),name:S.value})];return C.value&&(Object.assign(t,{tabindex:0,...E.value,onClick:O,onKeyup:D}),n.unshift(k(`div`,{ref:c,class:`q-expansion-item__toggle-focus q-icon q-focus-helper q-focus-helper--rounded`,tabindex:-1}))),k(K,t,()=>n)}function I(){let n;return t.header===void 0?(n=[k(K,()=>[k(W,{lines:e.labelLines},()=>e.label||``),e.caption?k(W,{lines:e.captionLines,caption:!0},()=>e.caption):null])],e.icon&&n[e.switchToggleSide?`push`:`unshift`](k(K,{side:e.switchToggleSide,avatar:!e.switchToggleSide},()=>k(N,{name:e.icon})))):n=[t.header(w.value)].flat(),!e.disable&&!e.hideExpandIcon&&n[e.switchToggleSide?`unshift`:`push`](F()),n}function ie(){let t={ref:`item`,style:e.headerStyle,class:e.headerClass,dark:a.value,disable:e.disable,dense:e.dense,insetLevel:e.headerInsetLevel};return x.value&&(t.clickable=!0,t.onClick=ee,Object.assign(t,y.value?b.value:E.value)),k(U,t,I)}function L(){return j(k(`div`,{key:`e-content`,class:`q-expansion-item__content relative-position`,style:v.value,id:l.value},P(t.default)),[[h,o.value]])}function R(){let t=[ie(),k(ve,{duration:e.duration,onShow:A,onHide:ne},L)];return e.expandSeparator&&t.push(k(z,{class:`q-expansion-item__border q-expansion-item__border--top absolute-top`,dark:a.value}),k(z,{class:`q-expansion-item__border q-expansion-item__border--bottom absolute-bottom`,dark:a.value})),t}return e.group!==void 0&&M(),f(()=>{g?.()}),()=>k(`div`,{class:_.value},[k(`div`,{class:`q-expansion-item__container relative-position`},R())])}}),xe=Object.assign({"/src/fixed-data/checklists/general/general.xml":`<?xml version="1.0" encoding="UTF-8"?>
<!--
...
`}),Se=class{getRawXml(e,t,n){let r=`/src/fixed-data/checklists/${e===`general`?`general/general`:`${e}/${t}`}`;return xe[`${r}.${n}.xml`]??xe[`${r}.xml`]}},Ce=class{constructor(e){G(this,`storage`,void 0),this.storage=e}load(e){let t=this.storage.getItem(e);if(!t)return{};try{return JSON.parse(t)}catch{return{}}}save(e,t){this.storage.setItem(e,JSON.stringify(t))}},we=M({name:`QBanner`,props:{...H,inlineActions:Boolean,dense:Boolean,rounded:Boolean},setup(e,{slots:t}){let{proxy:{$q:n}}=te(),i=V(e,n),a=r(()=>`q-banner row items-center`+(e.dense?` q-banner--dense`:``)+(i.value?` q-banner--dark q-dark`:``)+(e.rounded?` rounded-borders`:``)),o=r(()=>`q-banner__actions row items-center justify-end col-${e.inlineActions?`auto`:`all`}`);return()=>{let n=[k(`div`,{class:`q-banner__avatar col-auto row items-center self-start`},P(t.avatar)),k(`div`,{class:`q-banner__content col text-body2`},P(t.default))],r=P(t.action);return r!==void 0&&n.push(k(`div`,{class:o.value},r)),k(`div`,{class:a.value+(!e.inlineActions&&r!==void 0?` q-banner--top-padding`:``),role:`alert`},n)}}}),Te=Symbol(`checklistState`),Ee=Symbol(`checklistChange`),Y=class{constructor(e,t,n){G(this,`id`,void 0),G(this,`text`,void 0),G(this,`note`,void 0),this.id=e,this.text=t,this.note=n}},X=class{constructor(e,t,n){G(this,`id`,void 0),G(this,`text`,void 0),G(this,`note`,void 0),this.id=e,this.text=t,this.note=n}},De=class{constructor(e,t,n){G(this,`id`,void 0),G(this,`label`,void 0),G(this,`items`,void 0),this.id=e,this.label=t,this.items=n}},Z=class{constructor(e,t,n){G(this,`id`,void 0),G(this,`prompt`,void 0),G(this,`branches`,void 0),this.id=e,this.prompt=t,this.branches=n}},Oe=[`emergency`,`collapsed`,`dolist`];function ke(e){let t={};for(let n of Oe)t[n]=e.getAttribute(n)===`true`;return t}function Ae(e,t){let n={};for(let r of Oe)n[r]=e[r]||t[r];return n}var je=class{constructor(e,t,n,r){G(this,`id`,void 0),G(this,`title`,void 0),G(this,`flags`,void 0),G(this,`items`,void 0),this.id=e,this.title=t,this.flags=n,this.items=r}};function Q(e,t){let n=e.getAttribute(t);if(!n)throw Error(`<${e.tagName}> element is missing a "${t}" attribute`);return n}function Me(e,t){return Array.from(e.children).filter(e=>e.tagName===t)}function Ne(e){let t=[];for(let n of Array.from(e.children))switch(n.tagName){case`row`:t.push(Pe(n));break;case`choice`:t.push(Le(n));break;case`info`:t.push(Fe(n));break}return t}function Pe(e){return new Y(Q(e,`id`),e.textContent?.trim()??``,e.getAttribute(`note`))}function Fe(e){return new X(Q(e,`id`),e.textContent?.trim()??``,e.getAttribute(`note`))}function Ie(e){return new De(Q(e,`id`),e.getAttribute(`label`)??``,Ne(e))}function Le(e){return new Z(Q(e,`id`),e.getAttribute(`prompt`)??``,Me(e,`branch`).map(Ie))}function Re(e){return new je(Q(e,`id`),e.getAttribute(`title`)??``,ke(e),Ne(e))}var ze=class{constructor(e){G(this,`id`,void 0),G(this,`replace`,void 0),G(this,`sections`,void 0);let t=new DOMParser().parseFromString(e,`application/xml`),n=t.getElementsByTagName(`parsererror`)[0];if(n)throw Error(`Invalid checklist XML: ${n.textContent}`);let r=t.documentElement;if(r.tagName!==`checklist`)throw Error(`Checklist XML must have a <checklist> root element`);this.id=r.getAttribute(`id`)??``,this.replace=r.getAttribute(`replace`)===`true`,this.sections=Me(r,`section`).map(Re)}};function Be(e,t,n){let r=[...e];for(let e of t){let t=r.findIndex(t=>t.id===e.id);t>=0?r[t]=n(r[t],e):r.push(e)}return r}function Ve(e,t){return e instanceof Z&&t instanceof Z?new Z(t.id,t.prompt||e.prompt,Be(e.branches,t.branches,He)):e instanceof Y&&t instanceof Y?new Y(t.id,t.text||e.text,t.note??e.note):e instanceof X&&t instanceof X?new X(t.id,t.text||e.text,t.note??e.note):t}function He(e,t){return new De(t.id,t.label||e.label,Ue(e.items,t.items))}function Ue(e,t){return Be(e,t,Ve)}function We(e,t){return new je(t.id,t.title||e.title,Ae(e.flags,t.flags),Ue(e.items,t.items))}function Ge(e,t){return Be(e,t,We)}var Ke=class{constructor(e,t,n){if(G(this,`sections`,void 0),n?.replace){this.sections=n.sections;return}if(t){this.sections=n?Ge(t.sections,n.sections):t.sections;return}if(n){this.sections=n.sections;return}this.sections=e?.sections??[]}findSection(e){return this.sections.find(t=>t.id===e)}emergencySections(){return this.sections.filter(e=>e.flags.emergency)}},qe={class:`text-caption`},Je={key:2,class:`q-my-sm q-pl-sm`},Ye={class:`text-weight-medium`},Xe={class:`row q-gutter-xs q-my-xs`},Ze=t({__name:`ChecklistItemList`,props:{items:{}},setup(e){let t=A(Te),r=A(Ee);if(t===void 0||r===void 0)throw Error(`ChecklistItemList must be used within a component providing checklistStateKey`);let i=t,a=r;function s(e){return e instanceof Y}function c(e){return e instanceof X}function d(e){return e instanceof Z}function f(e){return e in i&&Object.hasOwn(i,e)}function h(e){let t=i[e.id];return e.branches.find(e=>e.id===t)}function g(e,t){t?i[e]=pe(new Date):delete i[e],a()}function v(e,t){i[e]=t,a()}return(t,r)=>{let a=u(`ChecklistItemList`,!0);return m(),o(de,{dense:``},{default:w(()=>[(m(!0),b(n,null,x(e.items,e=>(m(),b(n,{key:e.id},[s(e)?(m(),o(U,{key:0,tag:`label`,class:O({"items-start":!!e.note})},{default:w(()=>[C(K,{side:``,top:!!e.note},{default:w(()=>[C(ce,{"model-value":f(e.id),"onUpdate:modelValue":t=>g(e.id,t)},null,8,[`model-value`,`onUpdate:modelValue`])]),_:2},1032,[`top`]),C(K,null,{default:w(()=>[C(W,null,{default:w(()=>[S(E(e.text),1)]),_:2},1024),e.note?(m(),o(W,{key:0,caption:``},{default:w(()=>[S(E(e.note),1)]),_:2},1024)):_(``,!0)]),_:2},1024),f(e.id)?(m(),o(K,{key:0,side:``},{default:w(()=>[C(W,{caption:``},{default:w(()=>[S(E(p(i)[e.id]),1)]),_:2},1024)]),_:2},1024)):_(``,!0)]),_:2},1032,[`class`])):c(e)?(m(),o(we,{key:1,dense:``,class:`bg-blue-1 text-blue-10 q-my-xs`},l({default:w(()=>[S(E(e.text)+` `,1)]),_:2},[e.note?{name:`action`,fn:w(()=>[y(`span`,qe,E(e.note),1)]),key:`0`}:void 0]),1024)):d(e)?(m(),b(`div`,Je,[y(`div`,Ye,E(e.prompt),1),y(`div`,Xe,[(m(!0),b(n,null,x(e.branches,t=>(m(),o(I,{key:t.id,dense:``,"no-caps":``,outline:p(i)[e.id]!==t.id,color:p(i)[e.id]===t.id?`primary`:void 0,label:t.label,onClick:n=>v(e.id,t.id)},null,8,[`outline`,`color`,`label`,`onClick`]))),128))]),h(e)?(m(),o(a,{key:0,items:h(e).items},null,8,[`items`])):_(``,!0)])):_(``,!0)],64))),128))]),_:1})}}});function $(e,t,n,r){let i=e.getRawXml(t,n,r);return i?new ze(i):null}function Qe(e,t,n){return new Ke($(e,`general`,`general`,n),$(e,`model`,t.model,n),$(e,`plane`,t.immatriculation,n))}var $e={class:`q-gutter-md`},et={class:`row items-center q-gutter-md`},tt={class:`text-caption text-grey`},nt={class:`row q-gutter-xs q-mt-xs`},rt={key:1},it={key:2,class:`text-grey q-pa-md text-center`},at=ge(t({__name:`ChecklistPage`,setup(t){let l=se(),{t:u,locale:f}=e({useScope:`global`}),{confirmDialog:p}=he(),h=r(()=>l.screen.lt.sm),v=s(0);d(()=>{v.value=document.querySelector(`.q-header`)?.getBoundingClientRect().height??0});let te=new Se,D=new Ce(l.localStorage),k=r(()=>Object.values(q).sort((e,t)=>e.immatriculation.localeCompare(t.immatriculation)).map(e=>({label:e.toString(),value:e.immatriculation}))),A=s(``),j=r(()=>q[A.value]??null),re=s(me(new Date)),M;d(()=>{M=setInterval(()=>{re.value=me(new Date)},1e3)}),c(()=>{clearInterval(M)});let N=s(null),P=i({});function F(){let e=j.value;if(!e){N.value=null;return}N.value=Qe(te,e,f.value);for(let e of N.value.sections)e.id in P||(P[e.id]=!e.flags.collapsed)}T(f,F);function ie(e){return e.flags.emergency?`bg-red-1 text-red-10`:e.flags.dolist?`bg-blue-1 text-blue-10`:`bg-green-1 text-green-10`}let L=i({});function z(e){return`checklist.state.${e}`}function oe(){for(let e of Object.keys(L))delete L[e];let e=j.value;e&&Object.assign(L,D.load(z(e.immatriculation)))}function B(){let e=j.value;e&&D.save(z(e.immatriculation),{...L})}function ce(){B()}a(Te,L),a(Ee,ce);function V(e){A.value=e,l.sessionStorage?.setItem(`checklist.input.planeIdent`,e),F(),oe()}let H=new Map;function le(e,t){t?H.set(e,t):H.delete(e)}function U(e){let t=document.querySelector(`.checklist-sticky-bar`);if(!t)return;let n=t.getBoundingClientRect().bottom,r=e.getBoundingClientRect().top+window.scrollY-n-8;window.scrollTo({top:r,behavior:`smooth`})}function W(e){P[e]=!0,g(()=>{let t=H.get(e)?.$el;t&&U(t)})}let G=s(null);function de(){G.value&&U(G.value)}function pe(){if(N.value)for(let e of N.value.sections)e.flags.emergency||(P[e.id]=!1)}function ge(e){let t=[],n=e=>{for(let r of e)if(t.push(r.id),r instanceof Z)for(let e of r.branches)n(e.items)};return n(e.items),t}function ve(e){for(let t of ge(e))delete L[t];B()}function J(){p(u(`confirmClearAllChecklistMessage`)).onOk(()=>{for(let e of Object.keys(L))delete L[e];B()})}return d(()=>{let e=l.sessionStorage.getItem(`checklist.input.planeIdent`),t=e&&q[e]?e:k.value[0]?.value??``;t&&V(t)}),(e,t)=>(m(),o(fe,{padding:``,class:`col`},{default:w(()=>[y(`div`,$e,[C(R,{flat:``,bordered:``,class:`q-pa-sm checklist-sticky-bar`,style:ee({top:`${v.value}px`})},{default:w(()=>[y(`div`,et,[C(ue,{class:`col-12 col-sm`,modelValue:A.value,"onUpdate:modelValue":[t[0]||=e=>A.value=e,V],label:e.$t(`checklistPlaneLabel`),hint:e.$t(`checklistPlaneHint`),options:k.value,"emit-value":``,"map-options":``},null,8,[`modelValue`,`label`,`hint`,`options`]),y(`div`,{class:O([`col-auto text-weight-bold`,h.value?`text-body1`:`text-h6`])},E(re.value),3),h.value?(m(),o(_e,{key:0})):_(``,!0),N.value&&N.value.emergencySections().length?(m(),o(I,{key:1,flat:``,dense:``,icon:`warning`,color:`negative`,label:h.value?void 0:e.$t(`checklistEmergencyJumpLabel`),round:h.value,"aria-label":e.$t(`checklistEmergencyJumpLabel`),onClick:de},null,8,[`label`,`round`,`aria-label`])):_(``,!0),N.value?(m(),o(I,{key:2,flat:``,dense:``,icon:`unfold_less`,label:h.value?void 0:e.$t(`checklistCollapseAllLabel`),round:h.value,"aria-label":e.$t(`checklistCollapseAllLabel`),onClick:pe},null,8,[`label`,`round`,`aria-label`])):_(``,!0),N.value?(m(),o(I,{key:3,flat:``,dense:``,icon:`delete_sweep`,label:h.value?void 0:e.$t(`checklistClearAllLabel`),round:h.value,"aria-label":e.$t(`checklistClearAllLabel`),onClick:J},null,8,[`label`,`round`,`aria-label`])):_(``,!0)])]),_:1},8,[`style`]),N.value&&N.value.emergencySections().length?(m(),b(`div`,{key:0,ref_key:`emergencyPanelRef`,ref:G},[y(`span`,tt,E(e.$t(`checklistEmergencyJumpLabel`)),1),y(`div`,nt,[(m(!0),b(n,null,x(N.value.emergencySections(),e=>(m(),o(I,{key:e.id,outline:``,dense:``,"no-caps":``,color:`negative`,label:e.title,onClick:t=>W(e.id)},null,8,[`label`,`onClick`]))),128))])],512)):_(``,!0),N.value?(m(),b(`div`,rt,[(m(!0),b(n,null,x(N.value.sections,t=>(m(),o(be,{key:t.id,ref_for:!0,ref:e=>le(t.id,e),"model-value":P[t.id]??!1,"onUpdate:modelValue":e=>P[t.id]=e,"header-class":ie(t)},{header:w(()=>[C(K,null,{default:w(()=>[S(E(t.title),1)]),_:2},1024),C(K,{side:``},{default:w(()=>[C(I,{flat:``,dense:``,round:``,icon:`clear`,"aria-label":e.$t(`checklistClearSectionLabel`),onClick:ne(e=>ve(t),[`stop`])},null,8,[`aria-label`,`onClick`])]),_:2},1024)]),default:w(()=>[C(R,null,{default:w(()=>[C(ae,null,{default:w(()=>[C(Ze,{items:t.items},null,8,[`items`])]),_:2},1024)]),_:2},1024)]),_:2},1032,[`model-value`,`onUpdate:modelValue`,`header-class`]))),128))])):(m(),b(`div`,it,E(e.$t(`checklistNoPlaneSelected`)),1))])]),_:1}))}}),[[`__scopeId`,`data-v-b5ac4ce4`]]);export{at as default};