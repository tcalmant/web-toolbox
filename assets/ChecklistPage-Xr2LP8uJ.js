import{n as e}from"./vue-i18n-BnMVFRRW.js";import{$ as t,A as n,B as r,Bn as i,Bt as a,H as o,Hn as s,It as c,J as l,Kt as u,Mt as d,Ot as f,Qn as p,Rt as m,S as h,Tt as g,U as _,Un as v,V as y,W as b,Wt as x,X as S,Z as C,_n as w,fn as T,ir as E,rr as ee,st as D,t as O,tr as k,ut as A,vt as j,w as te,yn as ne}from"./runtime-dom.esm-bundler-CvL4s6M5.js";import{F as M,I as N,c as P,m as F,r as I,t as L}from"./QBtn-DrxD4dLu.js";import{B as R,V as z,_ as B,g as re,h as V,m as ie,p as ae,q as oe,t as H,v as se,y as U,z as ce}from"./index-CXzUFzMd.js";import{l as W,m as G,n as le,t as K,u as q}from"./defineProperty-mqC8zVOZ.js";import{t as ue}from"./QList-imQ1U-0I.js";import{t as de}from"./QPage-DZoET7rN.js";import{r as J}from"./time-D8MxIflX.js";import{r as fe,t as pe}from"./airplanesRepository-BOtvMLPC.js";import{t as me}from"./_plugin-vue_export-helper-BDNMzG2s.js";var he=N({name:`QSlideTransition`,props:{appear:Boolean,duration:{type:Number,default:300}},emits:[`show`,`hide`],setup(e,{slots:t,emit:n}){let r=!1,i,a,o=null,s=null,c,l;function u(){i?.(),i=null,r=!1,o!==null&&(clearTimeout(o),o=null),s!==null&&(clearTimeout(s),s=null),a?.removeEventListener(`transitionend`,c),c=null}function d(t,n,a){n!==void 0&&(t.style.height=`${n}px`),t.style.transition=`height ${e.duration}ms cubic-bezier(.25, .8, .50, 1)`,r=!0,i=a}function p(e,t){e.style.overflowY=null,e.style.height=null,e.style.transition=null,u(),t!==l&&n(t)}function m(t,n){let i=0;a=t,r?(u(),i=t.offsetHeight===t.scrollHeight?0:void 0):(l=`hide`,t.style.overflowY=`hidden`),d(t,i,n),o=setTimeout(()=>{o=null,t.style.height=`${t.scrollHeight}px`,c=e=>{s=null,(Object(e)!==e||e.target===t)&&p(t,`show`)},t.addEventListener(`transitionend`,c),s=setTimeout(c,e.duration*1.1)},100)}function h(t,n){let i;a=t,r?u():(l=`show`,t.style.overflowY=`hidden`,i=t.scrollHeight),d(t,i,n),o=setTimeout(()=>{o=null,t.style.height=0,c=e=>{s=null,(Object(e)!==e||e.target===t)&&p(t,`hide`)},t.addEventListener(`transitionend`,c),s=setTimeout(c,e.duration*1.1)},100)}return f(()=>{r&&u()}),()=>A(O,{css:!1,appear:e.appear,onEnter:m,onLeave:h},t.default)}}),Y=v({}),ge=Object.keys(I),_e=N({name:`QExpansionItem`,props:{...I,...z,...U,icon:String,label:String,labelLines:[Number,String],caption:String,captionLines:[Number,String],dense:Boolean,toggleAriaLabel:String,expandIcon:String,expandedIcon:String,expandIconClass:[Array,String,Object],duration:{},headerInsetLevel:Number,contentInsetLevel:Number,expandSeparator:Boolean,defaultOpened:Boolean,hideExpandIcon:Boolean,expandIconToggle:Boolean,switchToggleSide:Boolean,denseToggle:Boolean,group:String,popup:Boolean,headerStyle:[Array,String,Object],headerClass:[Array,String,Object]},emits:[...R,`click`,`afterShow`,`afterHide`],setup(e,{slots:t,emit:n}){let{proxy:{$q:i}}=D(),a=se(e,i),o=s(e.modelValue===null?e.defaultOpened:e.modelValue),c=s(null),l=ae(),{show:u,hide:d,toggle:p}=ce({showing:o}),m,g,_=r(()=>`q-expansion-item q-item-type q-expansion-item--${o.value?`expanded`:`collapsed`} q-expansion-item--${e.popup?`popup`:`standard`}`),v=r(()=>e.contentInsetLevel===void 0?null:{[`padding`+(i.lang.rtl?`Right`:`Left`)]:e.contentInsetLevel*56+`px`}),y=r(()=>!e.disable&&(e.href!==void 0||e.to!==void 0&&e.to!==null&&e.to!==``)),b=r(()=>{let t={};return ge.forEach(n=>{t[n]=e[n]}),t}),x=r(()=>y.value||!e.expandIconToggle),S=r(()=>e.expandedIcon!==void 0&&o.value?e.expandedIcon:e.expandIcon||i.iconSet.expansionItem[e.denseToggle?`denseIcon`:`icon`]),C=r(()=>!e.disable&&(y.value||e.expandIconToggle)),w=r(()=>({expanded:o.value,detailsId:l.value,toggle:p,show:u,hide:d})),E=r(()=>{let t=e.toggleAriaLabel===void 0?i.lang.label[o.value?`collapse`:`expand`](e.label):e.toggleAriaLabel;return{role:`button`,"aria-expanded":o.value?`true`:`false`,"aria-controls":l.value,"aria-label":t}});T(()=>e.group,e=>{g?.(),e!==void 0&&N()});function ee(e){y.value||p(e),n(`click`,e)}function O(e){e.keyCode===13&&k(e,!0)}function k(e,t){!t&&!e.qAvoidFocus&&c.value?.focus(),p(e),M(e)}function j(){n(`afterShow`)}function te(){n(`afterHide`)}function N(){m===void 0&&(m=ie()),o.value&&(Y[e.group]=m);let t=T(o,t=>{t?Y[e.group]=m:Y[e.group]===m&&delete Y[e.group]}),n=T(()=>Y[e.group],(e,t)=>{t===m&&e!==void 0&&e!==m&&d()});g=()=>{t(),n(),Y[e.group]===m&&delete Y[e.group],g=void 0}}function I(){let t={class:[`q-focusable relative-position cursor-pointer${e.denseToggle&&e.switchToggleSide?` items-end`:``}`,e.expandIconClass],side:!e.switchToggleSide,avatar:e.switchToggleSide},n=[A(P,{class:`q-expansion-item__toggle-icon`+(e.expandedIcon===void 0&&o.value?` q-expansion-item__toggle-icon--rotated`:``),name:S.value})];return C.value&&(Object.assign(t,{tabindex:0,...E.value,onClick:k,onKeyup:O}),n.unshift(A(`div`,{ref:c,class:`q-expansion-item__toggle-focus q-icon q-focus-helper q-focus-helper--rounded`,tabindex:-1}))),A(q,t,()=>n)}function L(){let n;return t.header===void 0?(n=[A(q,()=>[A(G,{lines:e.labelLines},()=>e.label||``),e.caption?A(G,{lines:e.captionLines,caption:!0},()=>e.caption):null])],e.icon&&n[e.switchToggleSide?`push`:`unshift`](A(q,{side:e.switchToggleSide,avatar:!e.switchToggleSide},()=>A(P,{name:e.icon})))):n=[t.header(w.value)].flat(),!e.disable&&!e.hideExpandIcon&&n[e.switchToggleSide?`unshift`:`push`](I()),n}function R(){let t={ref:`item`,style:e.headerStyle,class:e.headerClass,dark:a.value,disable:e.disable,dense:e.dense,insetLevel:e.headerInsetLevel};return x.value&&(t.clickable=!0,t.onClick=ee,Object.assign(t,y.value?b.value:E.value)),A(W,t,L)}function z(){return ne(A(`div`,{key:`e-content`,class:`q-expansion-item__content relative-position`,style:v.value,id:l.value},F(t.default)),[[h,o.value]])}function B(){let t=[R(),A(he,{duration:e.duration,onShow:j,onHide:te},z)];return e.expandSeparator&&t.push(A(V,{class:`q-expansion-item__border q-expansion-item__border--top absolute-top`,dark:a.value}),A(V,{class:`q-expansion-item__border q-expansion-item__border--bottom absolute-bottom`,dark:a.value})),t}return e.group!==void 0&&N(),f(()=>{g?.()}),()=>A(`div`,{class:_.value},[A(`div`,{class:`q-expansion-item__container relative-position`},B())])}}),ve=Object.assign({"/src/fixed-data/checklists/general/general.xml":`<?xml version="1.0" encoding="UTF-8"?>
<!--
...
`}),ye=class{getRawXml(e,t,n){let r=`/src/fixed-data/checklists/${e===`general`?`general/general`:`${e}/${t}`}`;return ve[`${r}.${n}.xml`]??ve[`${r}.xml`]}},be=class{constructor(e){K(this,`storage`,void 0),this.storage=e}load(e){let t=this.storage.getItem(e);if(!t)return{};try{return JSON.parse(t)}catch{return{}}}save(e,t){this.storage.setItem(e,JSON.stringify(t))}},xe=N({name:`QBanner`,props:{...U,inlineActions:Boolean,dense:Boolean,rounded:Boolean},setup(e,{slots:t}){let{proxy:{$q:n}}=D(),i=se(e,n),a=r(()=>`q-banner row items-center`+(e.dense?` q-banner--dense`:``)+(i.value?` q-banner--dark q-dark`:``)+(e.rounded?` rounded-borders`:``)),o=r(()=>`q-banner__actions row items-center justify-end col-${e.inlineActions?`auto`:`all`}`);return()=>{let n=[A(`div`,{class:`q-banner__avatar col-auto row items-center self-start`},F(t.avatar)),A(`div`,{class:`q-banner__content col text-body2`},F(t.default))],r=F(t.action);return r!==void 0&&n.push(A(`div`,{class:o.value},r)),A(`div`,{class:a.value+(!e.inlineActions&&r!==void 0?` q-banner--top-padding`:``),role:`alert`},n)}}}),Se=Symbol(`checklistState`),Ce=Symbol(`checklistChange`),X=class{constructor(e,t,n){K(this,`id`,void 0),K(this,`text`,void 0),K(this,`note`,void 0),this.id=e,this.text=t,this.note=n}},Z=class{constructor(e,t,n){K(this,`id`,void 0),K(this,`text`,void 0),K(this,`note`,void 0),this.id=e,this.text=t,this.note=n}},we=class{constructor(e,t,n){K(this,`id`,void 0),K(this,`label`,void 0),K(this,`items`,void 0),this.id=e,this.label=t,this.items=n}},Q=class{constructor(e,t,n){K(this,`id`,void 0),K(this,`prompt`,void 0),K(this,`branches`,void 0),this.id=e,this.prompt=t,this.branches=n}},Te=[`emergency`,`collapsed`,`dolist`];function Ee(e){let t={};for(let n of Te)t[n]=e.getAttribute(n)===`true`;return t}function De(e,t){let n={};for(let r of Te)n[r]=e[r]||t[r];return n}var Oe=class{constructor(e,t,n,r){K(this,`id`,void 0),K(this,`title`,void 0),K(this,`flags`,void 0),K(this,`items`,void 0),this.id=e,this.title=t,this.flags=n,this.items=r}};function $(e,t){let n=e.getAttribute(t);if(!n)throw Error(`<${e.tagName}> element is missing a "${t}" attribute`);return n}function ke(e,t){return Array.from(e.children).filter(e=>e.tagName===t)}function Ae(e){let t=[];for(let n of Array.from(e.children))switch(n.tagName){case`row`:t.push(je(n));break;case`choice`:t.push(Pe(n));break;case`info`:t.push(Me(n));break}return t}function je(e){return new X($(e,`id`),e.textContent?.trim()??``,e.getAttribute(`note`))}function Me(e){return new Z($(e,`id`),e.textContent?.trim()??``,e.getAttribute(`note`))}function Ne(e){return new we($(e,`id`),e.getAttribute(`label`)??``,Ae(e))}function Pe(e){return new Q($(e,`id`),e.getAttribute(`prompt`)??``,ke(e,`branch`).map(Ne))}function Fe(e){return new Oe($(e,`id`),e.getAttribute(`title`)??``,Ee(e),Ae(e))}var Ie=class{constructor(e){K(this,`id`,void 0),K(this,`replace`,void 0),K(this,`sections`,void 0);let t=new DOMParser().parseFromString(e,`application/xml`),n=t.getElementsByTagName(`parsererror`)[0];if(n)throw Error(`Invalid checklist XML: ${n.textContent}`);let r=t.documentElement;if(r.tagName!==`checklist`)throw Error(`Checklist XML must have a <checklist> root element`);this.id=r.getAttribute(`id`)??``,this.replace=r.getAttribute(`replace`)===`true`,this.sections=ke(r,`section`).map(Fe)}};function Le(e,t,n){let r=[...e];for(let e of t){let t=r.findIndex(t=>t.id===e.id);t>=0?r[t]=n(r[t],e):r.push(e)}return r}function Re(e,t){return e instanceof Q&&t instanceof Q?new Q(t.id,t.prompt||e.prompt,Le(e.branches,t.branches,ze)):e instanceof X&&t instanceof X?new X(t.id,t.text||e.text,t.note??e.note):e instanceof Z&&t instanceof Z?new Z(t.id,t.text||e.text,t.note??e.note):t}function ze(e,t){return new we(t.id,t.label||e.label,Be(e.items,t.items))}function Be(e,t){return Le(e,t,Re)}function Ve(e,t){return new Oe(t.id,t.title||e.title,De(e.flags,t.flags),Be(e.items,t.items))}function He(e,t){return Le(e,t,Ve)}var Ue=class{constructor(e,t,n){if(K(this,`sections`,void 0),n?.replace){this.sections=n.sections;return}if(t){this.sections=n?He(t.sections,n.sections):t.sections;return}if(n){this.sections=n.sections;return}this.sections=e?.sections??[]}findSection(e){return this.sections.find(t=>t.id===e)}emergencySections(){return this.sections.filter(e=>e.flags.emergency)}},We={class:`text-caption`},Ge={key:2,class:`q-my-sm q-pl-sm`},Ke={class:`text-weight-medium`},qe={class:`row q-gutter-xs q-my-xs`},Je=t({__name:`ChecklistItemList`,props:{items:{}},setup(e){let t=j(Se),r=j(Ce);if(t===void 0||r===void 0)throw Error(`ChecklistItemList must be used within a component providing checklistStateKey`);let i=t,a=r;function s(e){return e instanceof X}function c(e){return e instanceof Z}function d(e){return e instanceof Q}function f(e){return e in i&&Object.hasOwn(i,e)}function h(e){let t=i[e.id];return e.branches.find(e=>e.id===t)}function g(e,t){t?i[e]=J(new Date):delete i[e],a()}function v(e,t){i[e]=t,a()}return(t,r)=>{let a=u(`ChecklistItemList`,!0);return m(),o(ue,{dense:``},{default:w(()=>[(m(!0),b(n,null,x(e.items,e=>(m(),b(n,{key:e.id},[s(e)?(m(),o(W,{key:0,tag:`label`,class:k({"items-start":!!e.note})},{default:w(()=>[C(q,{side:``,top:!!e.note},{default:w(()=>[C(H,{"model-value":f(e.id),"onUpdate:modelValue":t=>g(e.id,t)},null,8,[`model-value`,`onUpdate:modelValue`])]),_:2},1032,[`top`]),C(q,null,{default:w(()=>[C(G,null,{default:w(()=>[S(E(e.text),1)]),_:2},1024),e.note?(m(),o(G,{key:0,caption:``},{default:w(()=>[S(E(e.note),1)]),_:2},1024)):_(``,!0)]),_:2},1024),f(e.id)?(m(),o(q,{key:0,side:``},{default:w(()=>[C(G,{caption:``},{default:w(()=>[S(E(p(i)[e.id]),1)]),_:2},1024)]),_:2},1024)):_(``,!0)]),_:2},1032,[`class`])):c(e)?(m(),o(xe,{key:1,dense:``,class:`bg-blue-1 text-blue-10 q-my-xs`},l({default:w(()=>[S(E(e.text)+` `,1)]),_:2},[e.note?{name:`action`,fn:w(()=>[y(`span`,We,E(e.note),1)]),key:`0`}:void 0]),1024)):d(e)?(m(),b(`div`,Ge,[y(`div`,Ke,E(e.prompt),1),y(`div`,qe,[(m(!0),b(n,null,x(e.branches,t=>(m(),o(L,{key:t.id,dense:``,"no-caps":``,outline:p(i)[e.id]!==t.id,color:p(i)[e.id]===t.id?`primary`:void 0,label:t.label,onClick:n=>v(e.id,t.id)},null,8,[`outline`,`color`,`label`,`onClick`]))),128))]),h(e)?(m(),o(a,{key:0,items:h(e).items},null,8,[`items`])):_(``,!0)])):_(``,!0)],64))),128))]),_:1})}}});function Ye(e,t,n,r){let i=e.getRawXml(t,n,r);return i?new Ie(i):null}function Xe(e,t,n){return new Ue(Ye(e,`general`,`general`,n),Ye(e,`model`,t.model,n),Ye(e,`plane`,t.immatriculation,n))}var Ze={class:`q-gutter-md`},Qe={class:`row items-center q-gutter-md`},$e={class:`col-auto text-h5 text-weight-bold`},et={key:0,class:`row q-gutter-xs q-mt-sm`},tt={class:`text-caption text-grey col-12`},nt={key:0},rt={key:1,class:`text-grey q-pa-md text-center`},it=me(t({__name:`ChecklistPage`,setup(t){let l=oe(),{t:u,locale:f}=e({useScope:`global`}),{confirmDialog:p}=fe(),h=s(0);d(()=>{h.value=document.querySelector(`.q-header`)?.getBoundingClientRect().height??0});let v=new ye,D=new be(l.localStorage),O=r(()=>Object.values(pe).sort((e,t)=>e.immatriculation.localeCompare(t.immatriculation)).map(e=>({label:e.toString(),value:e.immatriculation}))),k=s(``),A=r(()=>pe[k.value]??null),j=s(J(new Date)),ne;d(()=>{ne=setInterval(()=>{j.value=J(new Date)},1e3)}),c(()=>{clearInterval(ne)});let M=s(null),N=i({});function P(){let e=A.value;if(!e){M.value=null;return}M.value=Xe(v,e,f.value);for(let e of M.value.sections)e.id in N||(N[e.id]=!e.flags.collapsed)}T(f,P);function F(e){return e.flags.emergency?`bg-red-1 text-red-10`:e.flags.dolist?`bg-blue-1 text-blue-10`:`bg-green-1 text-green-10`}let I=i({});function R(e){return`checklist.state.${e}`}function z(){for(let e of Object.keys(I))delete I[e];let e=A.value;e&&Object.assign(I,D.load(R(e.immatriculation)))}function V(){let e=A.value;e&&D.save(R(e.immatriculation),{...I})}function ie(){V()}a(Se,I),a(Ce,ie);function ae(e){k.value=e,l.sessionStorage?.setItem(`checklist.input.planeIdent`,e),P(),z()}let H=new Map;function se(e,t){t?H.set(e,t):H.delete(e)}function U(e){N[e]=!0,g(()=>{let t=H.get(e)?.$el,n=document.querySelector(`.checklist-sticky-bar`);if(!t||!n)return;let r=n.getBoundingClientRect().bottom,i=t.getBoundingClientRect().top+window.scrollY-r-8;window.scrollTo({top:i,behavior:`smooth`})})}function ce(){if(M.value)for(let e of M.value.sections)e.flags.emergency||(N[e.id]=!1)}function W(e){let t=[],n=e=>{for(let r of e)if(t.push(r.id),r instanceof Q)for(let e of r.branches)n(e.items)};return n(e.items),t}function G(e){for(let t of W(e))delete I[t];V()}function K(){p(u(`confirmClearAllChecklistMessage`)).onOk(()=>{for(let e of Object.keys(I))delete I[e];V()})}return d(()=>{let e=l.sessionStorage.getItem(`checklist.input.planeIdent`),t=e&&pe[e]?e:O.value[0]?.value??``;t&&ae(t)}),(e,t)=>(m(),o(de,{padding:``,class:`col`},{default:w(()=>[y(`div`,Ze,[C(B,{flat:``,bordered:``,class:`q-pa-sm checklist-sticky-bar`,style:ee({top:`${h.value}px`})},{default:w(()=>[y(`div`,Qe,[C(le,{class:`col`,modelValue:k.value,"onUpdate:modelValue":[t[0]||=e=>k.value=e,ae],label:e.$t(`checklistPlaneLabel`),hint:e.$t(`checklistPlaneHint`),options:O.value,"emit-value":``,"map-options":``},null,8,[`modelValue`,`label`,`hint`,`options`]),y(`div`,$e,E(e.$t(`checklistClockLabel`))+` `+E(j.value),1),M.value?(m(),o(L,{key:0,flat:``,dense:``,icon:`unfold_less`,label:e.$t(`checklistCollapseAllLabel`),onClick:ce},null,8,[`label`])):_(``,!0),M.value?(m(),o(L,{key:1,flat:``,dense:``,icon:`delete_sweep`,label:e.$t(`checklistClearAllLabel`),onClick:K},null,8,[`label`])):_(``,!0)]),M.value&&M.value.emergencySections().length?(m(),b(`div`,et,[y(`span`,tt,E(e.$t(`checklistEmergencyJumpLabel`)),1),(m(!0),b(n,null,x(M.value.emergencySections(),e=>(m(),o(L,{key:e.id,outline:``,dense:``,"no-caps":``,color:`negative`,label:e.title,onClick:t=>U(e.id)},null,8,[`label`,`onClick`]))),128))])):_(``,!0)]),_:1},8,[`style`]),M.value?(m(),b(`div`,nt,[(m(!0),b(n,null,x(M.value.sections,t=>(m(),o(_e,{key:t.id,ref_for:!0,ref:e=>se(t.id,e),"model-value":N[t.id]??!1,"onUpdate:modelValue":e=>N[t.id]=e,"header-class":F(t)},{header:w(()=>[C(q,null,{default:w(()=>[S(E(t.title),1)]),_:2},1024),C(q,{side:``},{default:w(()=>[C(L,{flat:``,dense:``,round:``,icon:`clear`,"aria-label":e.$t(`checklistClearSectionLabel`),onClick:te(e=>G(t),[`stop`])},null,8,[`aria-label`,`onClick`])]),_:2},1024)]),default:w(()=>[C(B,null,{default:w(()=>[C(re,null,{default:w(()=>[C(Je,{items:t.items},null,8,[`items`])]),_:2},1024)]),_:2},1024)]),_:2},1032,[`model-value`,`onUpdate:modelValue`,`header-class`]))),128))])):(m(),b(`div`,rt,E(e.$t(`checklistNoPlaneSelected`)),1))])]),_:1}))}}),[[`__scopeId`,`data-v-fbe87a52`]]);export{it as default};