...
describe('Q section parser', () => {
  it('should accept valid Q sections', () => {
    ...
    expect(section.fir).toEqual('LFMM')
    expect(section.qCode).toEqual('QPLLT')
    expect(section.trafic).toEqual('V')
    expect(section.object).toEqual('M')
    expect(section.scope).toEqual('A')
    expect(section.limitLow).toEqual('000')
    expect(section.limitHigh).toEqual('999')
    ...
    expect(section.fir).toEqual('LFFF')
    expect(section.qCode).toEqual('QOBCE')
    expect(section.trafic).toEqual('IV')
    expect(section.object).toEqual('M')
    expect(section.scope).toEqual('AE')
    expect(section.limitLow).toEqual('005')
    expect(section.limitHigh).toEqual('008')
    expect(section.center).not.toBeNull()
    ...
    expect(section.fir).toEqual('LFRR')
    expect(section.qCode).toEqual('QICAS')
    expect(section.trafic).toEqual('I')
    expect(section.object).toEqual('NBO')
    expect(section.scope).toEqual('A')
    expect(section.limitLow).toEqual('000')
    expect(section.limitHigh).toEqual('999')
    expect(section.center).not.toBeNull()
    ...
    expect(section.fir).toEqual('LFXX')
    expect(section.qCode).toEqual('QAFCH')
    expect(section.trafic).toEqual('IV')
    expect(section.object).toEqual('NBO')
    expect(section.scope).toEqual('E')
    expect(section.limitLow).toEqual('115')
    expect(section.limitHigh).toEqual('195')
    expect(section.center).not.toBeNull()
  ...
  it('should accept partially empty Q sections', () => {
    ...
    expect(section.qCode).toEqual('QOBCE')
    expect(section.trafic).toEqual('IV')
    expect(section.object).toEqual('')
    expect(section.scope).toEqual('AE')
    expect(section.limitLow).toEqual('')
    expect(section.limitHigh).toEqual('')
    expect(section.center).not.toBeNull()
    expect(section.center?.lat).toBeCloseTo(48.68)
    expect(section.center?.lng).toBeCloseTo(2.22)
    expect(section.center?.alt).toBeUndefined()
